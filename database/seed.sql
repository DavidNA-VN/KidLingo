...
-- Phase 27 admin security monitoring demo events.
-- Keep deterministic examples for LOW/MEDIUM/HIGH dashboard states.
...
VALUES
  (
    ...
    'USER',
    NULL,
    'seed-security-login-1',
    '203.0.113.10',
    'seed-security-monitor',
    'POST',
    '/api/v1/auth/login',
    '{"reason":"INVALID_CREDENTIALS"}'::jsonb
  ),
  (
  ...
  (
    ...
    'seed-security-denied-1',
    '203.0.113.20',
    'seed-security-monitor',
    'GET',
    '/api/v1/admin/audit-logs',
    '{"required_role":"ADMIN"}'::jsonb
  ),
  (
  ...
  (
    ...
    'ASSIGNMENT',
    'dddddddd-dddd-dddd-dddd-ddddddddddd1',
    'seed-security-upload-1',
    '203.0.113.30',
    'seed-security-monitor',
    'POST',
    '/api/v1/teacher/assignments/dddddddd-dddd-dddd-dddd-ddddddddddd1/worksheet',
    '{"reason":"INVALID_FILE_TYPE","filename":"worksheet.exe"}'::jsonb
  ),
  (
  ...
  (
    'abababab-abab-abab-abab-ababababab08',
    ...
    'CLASS',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaa1',
    'seed-business-class-created',
    '203.0.113.40',
    'seed-security-monitor',
    'POST',
    '/api/v1/teacher/classes',
    '{"class_code":"SUNFLOWER-3"}'::jsonb
  ),
  (
    'abababab-abab-abab-abab-ababababab09',
    ...
    'POST',
    '/api/v1/ai/predict',
    '{"reason":"AI_SERVICE_UNAVAILABLE","child_id":"bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbb1"}'::jsonb
  ),
  (
    'abababab-abab-abab-abab-ababababab10',
